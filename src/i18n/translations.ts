...
export const locales: LocaleTable[] = [
  {
    ...
    translations: {
      ...
      'settings.resetStatsDescription': 'Очистить историю партий и настройку языка.',
      'settings.resetConfirmTitle': 'Сбросить данные?',
      'settings.resetConfirmMessage': 'Вы уверены, что хотите очистить историю партий и настройку языка? Это действие нельзя отменить.',
  ...
  },
  {
    ...
    translations: {
      ...
      'settings.resetStatsDescription': 'Clear match history and language preference.',
      'settings.resetConfirmTitle': 'Reset data?',
      'settings.resetConfirmMessage': 'Are you sure you want to clear match history and language preference? This action cannot be undone.',
